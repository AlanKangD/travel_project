...
<script type="text/javascript">
   ...
   /* function photo_add(){
	...
	function readURL(input) {
		...
		var str_file =
	    	  "<p><input type='file' name='review_file_name_"+(photo_count)+"' onchange='readURL(this)'/><a href='#this' id='photo_delete' class='btn'>삭제하기</a></p>";
	...
	<jsp:include page="../default/header.jsp"></jsp:include>
		<div id="wrap" style="width:600px; margin: 0 auto;">
			...
			<form method="post" action="${contextPath }/review/r_writeSave" enctype="multipart/form-data">
				...
				<div id="photo_div">
					<p>
					<input type="file" name="review_file_name_0" onchange="readURL(this)" id="photo"><!-- onchange="readURL(this)" 이미지를 미리보기 할 수 있음 -->
